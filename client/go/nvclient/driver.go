...
type Driver interface {
	...
	Search(object_type string, conditions map[string][]string, includes map[string][]string, fields []string) (Result, error)
	...
	GetAllFields(object_type string, command map[string][]string, includes map[string][]string, flags []string) (Result, error)
